...
```bash
INIT=$(node ".agent/get-shit-done/bin/gsd-tools.cjs" init new-milestone)
...
**Commit requirements:**
```bash
node ".agent/get-shit-done/bin/gsd-tools.cjs" commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
