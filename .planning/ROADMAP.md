...
**Plans**: 3 plans
- [x] 01-01-PLAN.md — Setup environment and Preprocessor (Pose + SAM 2)
- [x] 01-02-PLAN.md — Implement IDM-VTON Inference Engine & Weights
- [x] 01-03-PLAN.md — Expose as FastAPI API & E2E Verification
