...
- **Global scope**: `C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/notes/`)
...
2. Glob `C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/notes/` — works in any directory
