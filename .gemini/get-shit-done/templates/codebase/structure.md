...
- Usage: Reference from command with `@C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/umair/Videos/AI Virtual Try-On + Smart Styling Platform/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
